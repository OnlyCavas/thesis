...
\newcommand\med{\@setfontsize\med{12}{8.4}}
\newcommand\smaller{\@setfontsize\small{10}{8.4}}
\makeatother
...
\newcommand*{\authorcomplete}[2][]{
	\def\authrcompletenolink{#2}
	\ifthenelse{ \equal{#1}{} }{
		\def\authrcomplete{#2} }{
		\def\authrcomplete{\texorpdfstring{\href{#1}{#2}}{#2}}
	}
}
		...
		\raggedleft\parbox[b][297mm]{210mm}{% FRONT STARTS HERE
			...
			\begin{minipage}[b][297mm][t]{125mm}
				...
				\parbox[b][180mm][c]{125mm}{
					...
					\setstretch{1.2} {\large~\\}
					{\LargeA \authrnolink \\}
          {\large Master in Information Security \\
...
\newcommand\FrontCoverSingle{
    \put(0,0){\parbox[b][297mm]{210mm}{% FRONT STARTS HERE
			\raggedleft \hspace{25mm}
			\begin{minipage}[b][297mm][t]{125mm}
				\parbox[t]{125mm}{
					\raggedleft
          ...
          {\LargeA \authr \\}
          {\large \degree \\}
          {\small \deptname \\ \universityname \\ \the\year \\}
					% {\LargeA \authr \\}
					%      {\large Master in Information Security \\
					%      Department of Computer Science \\
					%      Faculty of Sciences of the University of Porto \\}
...
%-------------------------------------------------------------------------
%	STANDALONE FRONT COVER PAGE (single, A4, not double-wide)
%-------------------------------------------------------------------------

\eject \pdfpagewidth=210mm \pdfpageheight=297mm

\AddToShipoutPicture*{\FrontCoverSingle}
