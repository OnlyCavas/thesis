...
\begin{abstract}[
	...
	nameconnector={por},
        ...
        keywords={Torrent, Partilha de Ficheiros, Criptografia, Redes P2P, Segurança de Redes, Hardware Confiável, Bit Torrent, Segurança Peer-to-Peer, QUIC, Atestação Remota, Kademlia DHT, Resistência a Sybil (keywords em português)}]
