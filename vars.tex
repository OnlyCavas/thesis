...
\keywords{Torrent, File-Sharing, Cryptography, P2P network, Network Security, Trusted Hardware Execution, BitTorrent, Peer-to-Peer Security, QUIC, Remote Attestation, Kademlia DHT, Sybil Resistance}
