...
\thesistitle{Strengthening Torrent File-Sharing Protocol with the Cryptographic Hardware Solutions and Onion Network}

% Your thesis type Doctoral Thesis or Masters Thesis \ttype
\thesistype{Masters Thesis}

% Your supervisor's name
\supervisor[mailto:rmartins@fc.up.pt]{Rolando \textsc{Martins}}
...
% Your degree name
\degree{MSc Security Informatics}

% Your name
\authors[mailto:up202408560@edu.fc.up.pt]{Diogo \textsc{Assunção}}
...
\keywords{Torrent, File-Sharing, Cryptography, P2P network, Network Security, Trusted Hardware Execution, Bit Torrent, Peer-to-Peer Security, QUIC, Remote Attestation, Kademlia DHT, Sybil Resistance}
